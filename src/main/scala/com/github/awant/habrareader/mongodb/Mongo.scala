...
import com.github.awant.habrareader.models.{Chat, ChatScopeCodec, Event, Post}
...
object Mongo {
  ...
  lazy val codecRegistry: CodecRegistry = fromRegistries(fromProviders(classOf[Chat]), fromProviders(classOf[Post])), DEFAULT_CODEC_REGISTRY)
